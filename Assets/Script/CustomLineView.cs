...
namespace Yarn.Unity
{
    ...
    public class LineView : DialogueViewBase
    {
        ...
        /// </remarks>
        [SerializeField]
        internal Text characterNameText = null;
        ...
        /// </summary>
        CustomEffect.CoroutineInterruptToken currentStopToken = new CustomEffect.CoroutineInterruptToken();
        ...
        private IEnumerator DismissLineInternal(Action onDismissalComplete)
        {
            ...
            if (useFadeEffect)
            {
                yield return StartCoroutine(CustomEffect.FadeAlpha(canvasGroup, 1, 0, fadeOutTime, currentStopToken));
        ...
        public override void InterruptLine(LocalizedLine dialogueLine, Action onInterruptLineFinished)
        {
            ...
            lineText.text = dialogueLine.TextWithoutCharacterName.Text.Substring(0, length);
        ...
        private IEnumerator RunLineInternal(LocalizedLine dialogueLine, Action onDialogueLineFinished)
        {
            IEnumerator PresentLine()
            {
                ...
                if (useTypewriterEffect)
                {
                    ...
                    // in on visible text).
                    lineText.text = dialogueLine.TextWithoutCharacterName.Text.Substring(0, 0);
                }
                else
                {
                ...
                if (useFadeEffect)
                {
                    yield return StartCoroutine(CustomEffect.FadeAlpha(canvasGroup, 0, 1, fadeInTime, currentStopToken));
